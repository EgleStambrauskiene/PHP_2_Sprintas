...
<div class="uk-margin-bottom">
<a href="<?= BASE_URL . '/persons/list';?>" class="uk-icon-link uk-margin-right-small" uk-icon="icon: list; ratio: 1.25"></a>
<span><?= __('List');?></span>
</div>
...
<h5><?= __('Actions');?></h5>
<input class="uk-checkbox" type="checkbox" name="trash[]" value="<?= $person['id'];?>">&nbsp;
